...
pct_gasto_tp_dec %>% 
  ...
  labs(title = "Porcentaje de ingreso medio destinado a transporte público",
       ...
       Nota 2: Para revisar el nivel de confianza de las estimaciones, se recomienda ir a la tabla pct_gasto_tp_dec e interpretar acorde a las categorias alta, moderada y baja utilizadas por INEGI.
...
pct_gasto_tp_dec_pg %>% 
  ...
  labs(title = "Porcentaje de ingreso medio destinado a transporte público, considerando género de la jefa del hogar",
       ...
       Nota 2: Para revisar el nivel de confianza de las estimaciones, se recomienda ir a la tabla pct_gasto_tp_dec_pg e interpretar acorde a las categorias alta, moderada y baja utilizadas por INEGI.
       Elaborado por @jkvisfocri"
       )